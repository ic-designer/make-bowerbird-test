...
$(call bowerbird::test::generate-runner,test-pattern-test-files-alpha-runner,test/mock-tests)
test-pattern-test-files-alpha:
	$(call bowerbird::test::compare-sets,$(BOWERBIRD_TEST/FILES/$@-runner),\
			$(abspath test/mock-tests/alpha/mock-test-alpha.mk))


$(call bowerbird::test::pattern-test-files,*beta.mk)
$(call bowerbird::test::generate-runner,test-pattern-test-files-beta-runner,test/mock-tests)
test-pattern-test-files-beta:
	$(call bowerbird::test::compare-sets,\
			$(BOWERBIRD_TEST/FILES/$@-runner),\
			$(abspath test/mock-tests/alpha/beta/mock-test-beta.mk))


$(call bowerbird::test::pattern-test-files,*gamma.mk)
$(call bowerbird::test::generate-runner,test-pattern-test-files-gamma-runner,test/mock-tests)
...
$(call bowerbird::test::generate-runner,test-pattern-test-files-no-match-runner,test/mock-tests)
