...
test-runner-action-run-test-targets-failing-test-generate-log-file:
	$(MAKE) @bowerbird-test/run-test-target/mock-test/$@/failing-test/mock-runner \
			BOWERBIRD_TEST/CONFIG/FAIL_EXIT_CODE=0
	test -f $(BOWERBIRD_TEST/CONSTANT/WORKDIR_LOGS)/mock-runner/mock-test/$@/failing-test.$(BOWERBIRD_TEST/CONSTANT/EXT_LOG)

test-runner-action-run-test-targets-failing-test-generate-failed-response-file:
	$(MAKE) @bowerbird-test/run-test-target/mock-test/$@/failing-test/mock-runner \
			BOWERBIRD_TEST/CONFIG/FAIL_EXIT_CODE=0
	test -f $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/failing-test.$(BOWERBIRD_TEST/CONSTANT/EXT_FAIL)

test-runner-action-run-test-targets-failing-test-do-not-generate-passing-response-file:
	$(MAKE) @bowerbird-test/run-test-target/mock-test/$@/failing-test/mock-runner \
			BOWERBIRD_TEST/CONFIG/FAIL_EXIT_CODE=0
	test ! -f $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/failing-test.$(BOWERBIRD_TEST/CONSTANT/EXT_PASS)
...
test-runner-action-run-test-targets-failing-test-response-file-contents:
	...
	$(call bowerbird::test::compare-strings,\
			$$(cat $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/failing-test.$(BOWERBIRD_TEST/CONSTANT/EXT_FAIL)),\
...
test-runner-action-run-test-targets-passing-test-generate-log-file:
	...
	test -f $(BOWERBIRD_TEST/CONSTANT/WORKDIR_LOGS)/mock-runner/mock-test/$@/passing-test.$(BOWERBIRD_TEST/CONSTANT/EXT_LOG)

test-runner-action-run-test-targets-passing-test-generate-passing-response-file:
	$(MAKE) @bowerbird-test/run-test-target/mock-test/$@/passing-test/mock-runner \
			BOWERBIRD_TEST/CONFIG/FAIL_EXIT_CODE=0
	test -f $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/passing-test.$(BOWERBIRD_TEST/CONSTANT/EXT_PASS)

test-runner-action-run-test-targets-passing-test-do-not-generate-failing-response-file:
	$(MAKE) @bowerbird-test/run-test-target/mock-test/$@/passing-test/mock-runner \
			BOWERBIRD_TEST/CONFIG/FAIL_EXIT_CODE=0
	test ! -f $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/passing-test.$(BOWERBIRD_TEST/CONSTANT/EXT_FAIL)
...
test-runner-action-run-test-targets-passing-test-response-file-contents:
	...
	test -f $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/passing-test.$(BOWERBIRD_TEST/CONSTANT/EXT_PASS)
	$(call bowerbird::test::compare-strings,\
			$$(cat $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/passing-test.$(BOWERBIRD_TEST/CONSTANT/EXT_PASS)),\
...
test-runner-action-run-test-targets-undefined-variable-generate-log-file:
	$(MAKE) @bowerbird-test/run-test-target/mock-test/$@/undefined-variable-test/mock-runner \
			BOWERBIRD_TEST/CONFIG/FAIL_EXIT_CODE=0 2>/dev/null
	test -f $(BOWERBIRD_TEST/CONSTANT/WORKDIR_LOGS)/mock-runner/mock-test/$@/undefined-variable-test.$(BOWERBIRD_TEST/CONSTANT/EXT_LOG)

test-runner-action-run-test-targets-undefined-variable-test-generate-failed-response-file:
	$(MAKE) @bowerbird-test/run-test-target/mock-test/$@/undefined-variable-test/mock-runner \
			BOWERBIRD_TEST/CONFIG/FAIL_EXIT_CODE=0 2>/dev/null
	test -f $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/undefined-variable-test.$(BOWERBIRD_TEST/CONSTANT/EXT_FAIL)

test-runner-action-run-test-targets-undefined-variable-test-do-not-generate-passing-response-file:
	$(MAKE) @bowerbird-test/run-test-target/mock-test/$@/undefined-variable-test/mock-runner \
			BOWERBIRD_TEST/CONFIG/FAIL_EXIT_CODE=0 2>/dev/null
	test ! -f $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/undefined-variable-test.$(BOWERBIRD_TEST/CONSTANT/EXT_PASS)
...
test-runner-action-run-test-targets-undefined-variable-test-response-file-contents:
	...
	test -f $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/undefined-variable-test.$(BOWERBIRD_TEST/CONSTANT/EXT_FAIL)
	$(call bowerbird::test::compare-strings,\
			$$(cat $(BOWERBIRD_TEST/CONSTANT/WORDDIR_RESULTS)/mock-runner/mock-test/$@/undefined-variable-test.$(BOWERBIRD_TEST/CONSTANT/EXT_FAIL)),\
...
test-runner-action-run-test-targets-hierarchical-name-generate-log-file:
	...
	test -f $(BOWERBIRD_TEST/CONSTANT/WORKDIR_LOGS)/mock-runner/mock-test/$@/alpha/beta/passing-test.$(BOWERBIRD_TEST/CONSTANT/EXT_LOG)
