test-run-test-decorator-failing-test-log-file-names:
	...
	test -f $(WORKDIR_TEST)/mock-test/$@/failing-test/failing-test.$(BOWERBIRD_TEST_STDOUT_EXT)
	test -f $(WORKDIR_TEST)/mock-test/$@/failing-test/failing-test.$(BOWERBIRD_TEST_STDERR_EXT)
...
test-run-test-decorator-passing-test-log-file-names:
	...
	test -f $(WORKDIR_TEST)/mock-test/$@/passing-test/passing-test.$(BOWERBIRD_TEST_STDOUT_EXT)
	test -f $(WORKDIR_TEST)/mock-test/$@/passing-test/passing-test.$(BOWERBIRD_TEST_STDERR_EXT)
...
test-run-test-decorator-hierarchical-name-log-file-names:
	...
	test -f $(WORKDIR_TEST)/mock-test/$@/alpha/beta/passing-test/passing-test.$(BOWERBIRD_TEST_STDOUT_EXT)
	test -f $(WORKDIR_TEST)/mock-test/$@/alpha/beta/passing-test/passing-test.$(BOWERBIRD_TEST_STDERR_EXT)
