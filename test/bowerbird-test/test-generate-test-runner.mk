...
test-generate-test-runner-mock-test-files:
	$(call bowerbird::test::compare-string,$(BOWERBIRD_TEST_FILES/mock-tests),$(abspath test/mock-tests/alpha/beta/gamma/mock-test-gamma.mk) $(abspath test/mock-tests/alpha/beta/mock-test-beta.mk) $(abspath test/mock-tests/alpha/mock-test-alpha.mk))

.PHONY: test-generate-test-runner-mock-test-targets
test-generate-test-runner-mock-test-targets:
	$(call bowerbird::test::compare-string,$(sort $(BOWERBIRD_TEST_TARGETS/mock-tests)),$(sort test-find-files-gamma-1 test-find-files-gamma-2 test-find-files-beta-1 test-find-files-beta-2 test-find-files-alpha-1 test-find-files-alpha-2))
